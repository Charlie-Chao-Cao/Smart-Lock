...
//#define          RC522_CS_Enable()         (GPIOA->BSRR=1<<(16+4))
//#define          RC522_CS_Disable()        (GPIOA->BSRR=1<<4)

//#define          RC522_Reset_Enable()      (GPIOA->BSRR=1<<(16+0))
//#define          RC522_Reset_Disable()     (GPIOA->BSRR=1)

//#define          RC522_SCK_0()             (GPIOA->BSRR=1<<(16+5))
//#define          RC522_SCK_1()             (GPIOA->BSRR=1<<5)

//#define          RC522_MOSI_0()            (GPIOA->BSRR=1<<(16+7))
//#define          RC522_MOSI_1()            (GPIOA->BSRR=1<<7)
